...
<div>
<ol  class="no-style separator">
  <li>
    The <strong>largest recorded earthquake in the United States</strong> was
    a magnitude 9.2 that struck Prince William Sound, Alaska on Good Friday,
    March 28, 1964 UTC.
  </li>
  <li>
    The <strong>largest recorded earthquake in the world</strong> was a
    magnitude 9.5 (Mw) in Chile on May 22, 1960.
  </li>
  <li>
    The <strong>earliest reported earthquake in California</strong> was felt
  ...
  <li>
    ...
    built large <strong>spring-pendulum seismometers</strong> in an attempt to
  ...
  <figure class='right'>
    <img src="images/pwaves_fourcolumn.gif" alt="P waves" />
  </figure>
  <li>
    The <strong>fastest wave</strong>, and therefore the first to arrive at a given
  ...
  <li>
    The <strong>average rate of motion across the San Andreas Fault Zone
    </strong> during the past 3 million years is 56 mm/yr (2 in/yr). This is
  ...
  <li>
    The <strong>East African Rift System</strong> is a 50-60 km (31-37 miles)
  ...
  <li>
    The <strong>first &ldquo;pendulum seismoscope&rdquo;</strong> to measure
    the shaking of the ground during an earthquake was developed in 1751, and
    it wasn&rsquo;t until 1855 that faults were recognized as the source of
    earthquakes.
  </li>
  <li>
    <strong>Moonquakes</strong> (&ldquo;earthquakes&rdquo; on the moon) do
  ...
  <li>
    Although both are sea waves, a <strong>tsunami and a tidal wave</strong>
  ...
  <li>
    The <strong>hypocenter</strong> of an earthquake is the location beneath
    the earth&rsquo;s surface where the rupture of the fault begins. The
    <strong>epicenter</strong> of an earthquake is the location directly above
    the hypocenter on the surface of the earth.
  </li>

  <figure class='right'>
    <img src="images/pacific_basin_fourcolumn.gif" alt="Pacific Basin" />
  </figure>
  <li>
    The <strong>&ldquo;Ring of Fire&rdquo;</strong> also called the Circum-Pacific belt,
    is the zone of earthquakes surrounding the Pacific Ocean — about
    90&#37; of the world&rsquo;s earthquakes occur there. The next most
  ...
  <li>
    It is estimated that there are <strong>500,000 detectable earthquakes
    </strong> in the world each year. 100,000 of those can be felt, and 100 of
    them cause damage.
  </li>
  <li>
    It is thought that more damage was done by the resulting fire after the
    <strong>1906 San Francisco earthquake</strong> than by the earthquake
    itself.
  </li>
  <li>
    A <strong>seiche</strong> (pronounced SAYSH) is what happens in the
    swimming pools of Californians during and after an earthquake. It is
    &ldquo;an internal wave oscillating in a body of water&rdquo; or, in other
  ...
  <li>
    Each year the <strong>southern California area has about 10,000
    earthquakes</strong>. Most of them are so small that they are not felt.
  ...
  <li>
    The <strong>magnitude</strong> of an earthquake is a measured value of the
    ...
    <strong>intensity</strong> of an earthquake is a measure of the shaking
  ...
  <li>
    The world&rsquo;s <strong>greatest land mountain range</strong> is the
    Himalaya-Karakoram. It countains 96 of the world&rsquo;s 109 peaks of over
  ...
  <figure class='right'>
    <img src="images/midatlant_twocolumn.gif" alt="mid-Atlantic Ridge"\>
  </figure>
  <li>
    The greatest mountain range in the world, though, is the <strong<Mid-Ocean
    Ridge</strong>, extending 64,374 km (40,000 mi) from the Arctic Ocean to the Atlantic Ocean, around Africa, Asia, and Australia, and under the Pacific Ocean to the west coast of North America. It has a greatest height of 4207m (13,800 ft) above the base ocean depth.
  </li>
  <li>
    As far as we know, there is no such thing as <b>"earthquake weather"</b>.
  ...
  <li>
    From 1975-1995 there were only <strong>four states that did not have any
    earthquakes</strong>. They were: Florida, Iowa, North Dakota, and
    Wisconsin.
  </li>
  <li>
    The <strong>core of the earth</strong> was the first internal structural
  ...
  <li>
    ...
    sloshing (seiche) caused by the <strong>1985 M8.1 Michoacan, Mexico
    earthquake</strong> 2000 km (1240 miles) away.
  </li>
  <li>
    ...
    <strong>Mississippi Valley in 1811-1812</strong>. Because of the crustal
  ...
  <li>
    Most earthquakes occur at depths of <strong>less than 80 km
    (50 miles)</strong> from the Earth&rsquo;s surface.
  </li>

  <figure class='right'>
    <img src="images/calif_twocolumn.gif" alt="California" class="left"/>
  </figure>
  <li>
    The <strong>San Andreas fault is NOT a single, continuous fault</strong>,
  ...
  <li>
    The <strong>origin of the name of the San Andreas Fault</strong> is often cited as the
  ...
  <li>
    The <strong>world&rsquo;s deadliest recorded earthquake</strong> occurred
  ...
  <li>
    Florida and North Dakota have the <strong>smallest number of
    earthquakes</strong> in the United States.
  </li>
  <li>
    The <strong>deepest earthquakes</strong> typically occur at plate
    boundaries where the Earth&rdquo;s crust is being subducted into the
    Earth&rsquo;s mantle. These occur as deep as 750 km (400 miles) below the
    surface.
  </li>
  <li>
    Alaska is the <strong>most earthquake-prone state</strong> and one of the
  ...
  <li>
    The <strong>majority of the earthquakes and volcanic eruptions</strong>
  ...
  <li>
    The <strong>earliest recorded evidence of an earthquake</strong> has been
  ...
  <li>
    ...
    <strong>soft ground shakes more than hard rock</strong> in an earthquake.
  </li>
  <li>
    The <strong>cause of earthquakes was stated correctly in 1760</strong> by
    ...
    make are caused by &ldquo;shifting masses of rock miles below the
    surface&rdquo;.
  </li>

  <figure class='right'>
    <img src="images/oceancont_fourcolumn.gif" alt="ocean-cont collision"/>
  </figure>
  <li>
    <strong>Subduction</strong> is the process of the oceanic lithosphere colliding with and descending beneath the continental lithosphere.
  </li>
  <li>
    In 1663 the European settlers experienced their <strong>first earthquake
    in America</strong>.
  </li>
  <li>
    ...
    frequency in the audible range, it will be heard as a rumble. <strong>Most
    earthquake waves have a frequency of less than 20 Hz</strong>, so the
  ...
  <li>
    When the Chilean earthquake occurred in 1960, <strong>seismographs
    recorded seismic waves that traveled all around the Earth</strong>. These
    seismic waves shook the entire earth for many days! This phenomenon is
    called the free oscillation of the Earth.
  </li>
  <li>
    The <strong>interior of Antarctica has icequakes</strong> which, although
