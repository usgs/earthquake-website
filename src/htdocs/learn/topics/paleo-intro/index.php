...
<figure class='right'>
  ...
  <figcaption>
    Fault scarp produced during the South Napa earthquake in 2014 on the Napa fault, in a vineyard near Buhman Avenue (Dan Ponti, USGS).
  </figcaption>
</figure>
...
<figure class='lidar'>
  <img src='images/lidar.gif' alt='lidar image'/>
  <figcaption>
    These three photos show on the left a photo from the air, in the middle a first return lidar, and on the right a bare earth lidar for a location along the San Andreas Fault where it crosses Annapolis Rd south of Gualala. The fault is difficult to see in the air photo and first return lidar, but is obvious in the bare earth lidar.
  </figcaption>
</figure>
...
<figure class='right cartoon'>
  ...
  <figcaption>
    Cartoon showing horizontal sediments offset by two paleoearthquake fissures (red lines) that were at the ground surface at the time of each earthquake. The fissures were subsequently filled by the next layer of sediment. (Kate Scharer, USGS)
  </figcaption>
</figure>
<p>
...
<figure class='wall'>
  ...
  <figcaption>
    Fault produced during large magnitude earthquake on the San Andreas Fault at Pallett Creek, California when organic rich layer 4 was at the ground surface. Note that silt and sand layer  5 is thicker on the left side of the fault, where it filled in the step (scarp) made by motion on the fault.  Layers 5 and 6 are not affected by the fault. (Kate Scharer, USGS)
  </figcaption>
</figure>
...
<figure class='right charcoal'>
  ...
  <figcaption>
    Piece of charcoal in silt and sand layer 1 used in radiocarbon dating. (See red box in bottom left of photo.) (Kate Scharer, USGS)
  </figcaption>
</figure>
...
<h2 style="clear:left;"/>Estimating Paleoearthquake Magnitudes</h2>
<p>
