...
<p>
  It may be so light that only sensitive instruments will perceive its motion;
  ...
  unpopulated areas far from civilization.
</p>

<figure class="left">
	<img src="/learn/glossary/images/ringoffire.gif" alt="Pacific Ring of Fire"/>
</figure>

<p>
  Since a major portion of the world's earthquakes each year
  ...
  But it could hit any location, because no region is entirely free of earthquakes.
</p>

<p>
  Stating that an earthquake is going to occur today is not
  ...
  will center and when it will occur.
</p>

<p>
  Earthquake prediction may some day become a reality,
  but only after much more is learned about earthquakes.
</p>
