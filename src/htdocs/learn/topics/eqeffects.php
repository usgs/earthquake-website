...
<p>
  Ground shaking is a term used to describe the vibration of the ground during an earthquake. Ground shaking is caused by
  <a href="../glossary/?term=body%20wave">body waves</a> and <a href="../glossary/?term=surface%20wave">surface waves</a>. As a generalization, the severity of ground shaking increases as <a href="../glossary/?term=magnitude">magnitude</a> increases and decreases as distance from the causative fault increases. Although the physics of seismic waves is complex, ground shaking can be explained in terms of body waves, compressional, or <a href="../glossary/?term=P%20wave">P</a>, and shear, or <a href="../glossary/?term=S%20wave">S</a>, and surface waves, Rayleigh and Love.
</p>
...
<p>
  In land-use zoning and earthquake resistant design, knowledge of the amplitude, frequency composition, and the time duration of ground shaking is needed. These quantities can be determined from empirical (observed) data correlating them with the magnitude and the distribution of Modified Mercalli <a href="../glossary/?term=intensity">intensity</a> of the earthquake, distance of the building from the causative fault, and the physical properties of the <a href="../glossary/?term=soil">soil</a> and rock underlying the building. The subjective numerical value of the Modified Mercalli Intensity Scale indicates the effects of ground shaking on man, buildings, and the surface of the Earth.
</p>
...
<p>
  Taken from: Hays, W.W., ed., 1981, Facing Geologic and Hydrologic Hazards -- Earth Science Considerations: U.S. Geological Survey Professional Paper 1240B, 108 p. <br>
</p>

<h2>Surface Faulting</h2>

<p>
  <a href="../glossary/?term=surface%20faulting">Surface faulting</a> is the differential movement of the two sides of a fracture at the Earth's surface and can be <a href="../glossary/?term=strike-slip">strike-slip</a>, <a href="../glossary/?term=normal%20fault">normal</a>, and reverse (or <a href="../glossary/?term=thrust%20fault">thrust</a>). Combinations of the strike-slip type and the other two types of faulting can be found. Although <a href="../glossary/?term=displacement">displacements</a> of these kinds can result from <a href="../glossary/?term=landslide">landslides</a> and other shallow processes, surface faulting, as the term is used here, applies to differential movements caused by deep-seated forces in the Earth, the slow movement of sedimentary deposits toward the Gulf of Mexico, and faulting associated with salt domes.
</p>
...
<p>
  Liquefaction causes three types of ground failure: <a href="../glossary/?term=lateral%20spread%20or%20flow">lateral spreads</a>, flow failures, and loss of bearing strength. In addition, liquefaction enhances ground settlement and sometimes generates sand boils (fountains of water and sediment emanating from the pressurized liquefied zone). <a href="../glossary/?term=sand%20boil">Sand boils</a> can cause local flooding and the deposition or accumulation of silt.
</p>

<p>
  <a href="../glossary/?term=lateral%20spread%20or%20flow">Lateral Spreads</a> - Lateral spreads involve the lateral movement of large blocks of soil as a result of liquefaction in a subsurface layer. Movement takes place in response to the ground shaking generated by an earthquake. Lateral spreads generally develop on gentle slopes, most commonly on those between 0.3 and 3 degrees. Horizontal movements on lateral spreads commonly are as much as 10 to 15 feet, but, where slopes are particularly favorable and the duration of ground shaking is long, lateral movement may be as much as 100 to 150 feet. Lateral spreads usually break up internally, forming numerous fissures and scarps.
</p>
...
<p>
  The size of the area affected by earthquake-induced landslides depends on the <a href="../glossary/?term=magnitude">magnitude</a> of the earthquake, its <a href="../glossary/?term=focal%20depth">focal depth</a>, the topography and geologic conditions near the causative fault, and the <a href="../glossary/?term=amplitude">amplitude</a>, <a href="../glossary/?term=frequency">frequency</a> composition, and duration of ground shaking. In past earthquakes, landslides have been abundant in some areas having intensities of ground shaking as low as VI on the <a href="../glossary/?term=Modified%20Mercalli%20Intensity%20Scale">Modified Mercalli Intensity Scale</a>.
</p>
