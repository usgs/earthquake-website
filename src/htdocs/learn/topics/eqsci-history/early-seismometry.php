...
<ul>
  ...
  <li><a href="#earliest">The Earliest Seismoscope</a></li>
  <li><a href="#eighteenthc">Seismoscopes in Eighteenth Century Europe</a></li>
  <li><a href="#jamesforbes">The "Seismometer" of James Forbes</a></li>
  <li><a href="#studies">Further Studies with Seismoscopes</a></li>
  <li><a href="#invention">The Invention of a Seismograph in Italy</a></li>
  <li><a href="#development">The Development of the Seismograph in Japan</a></li>
  <li><a href="#international">The Seismograph Becomes an International Instrument</a></li>
  <li><a href="#microseisms">Early Studies of "Microseisms"</a></li>
  <li><a href="#tilt">The Tilt Controversy</a></li>
  <li><a href="#gottingen">The G&#246;ttingen Seismographs</a></li>
...
<p><a href='#content'>Back to the top</a></p>
<hr/>
...
<h2 id='earliest'>The Earliest Seismoscope</h2>
<figure class='right'>
  <img src="images/fig_01.png" alt=""/>
  <figcaption>
...
<h2 id='eighteenthc'>Seismoscopes in Eighteenth Century Europe</h2>
<p>
...
<h2 id='jamesforbes'>The "Seismometer" of James Forbes</h2>

<figure class='right'>
  <img src="images/fig_02.png" alt=""/>
  <figcaption>
    Figure 2. Forbes' seismometer (after Forbes, 1844). The screws <i>E</i>, acting on the support <i>D</i>, are used to help set the pendulum in an upright position.
  </figcaption>
</figure>
...
<h2 id='studies'>Further Studies with Seismoscopes</h2>
<p>
...
<figure>
  <img src="images/fig_03.png" alt=""/>
  <figcaption>
    Figure 3. Mallet's seismoscope (after Mallet, 1852). The image of a cross-hairs in <i>C</i> is reflected from the surface of mercury in the basin <i>B</i> and viewed through a magnifier, <i>D</i>.
  </figcaption>
</figure>
...
<figure>
  <img src="images/fig_06.png" alt=""/>
  <figcaption>
    Figure 6. The record obtained by a Cecchi seismograph at Moncalieri, Italy, on February 23, 1887 (reproduced from Fouqu&#233;, <i>Tremblements de Terre</i>, Bailli&#233;re, p. 79).
  </figcaption>
</figure>
...
<h2 id='development'>The Development of the Seismograph in Japan</h2>
<p>
...
<figure class='right'>
  ...
  <figcaption>
    Figure 11. "Shake table" test of Ewing's horizontal seismograph (reproduced from <i>Memoires of the Science Dept., Univ. of Tokyo</i>, no. 9, plate XXII). <i>a</i> represents the motion of the "table"; <i>b</i> the motion of the table as it was recorded by the seismograph. A time scale is not given.
  </figcaption>
</figure>
...
<figure class='left'>
  ...
  <figcaption>
    Figure 12. Ewing's suspension for detecting vertical motion (after Ewing, 1882a). The spring is attached below the line between the pendulum's center of mass and the pivot point, <i>B</i>.
  </figcaption>
</figure>
...
<figure class='right'>
  ...
  <figcaption>
    Figure 13. The Ewing duplex-pendulum seismometer (after Ewing, 1883a). The bob, <i><math>B<sub>1</sub></math></i> is connected at <i>A</i> to the bob <i><math>B<sub>2</sub></math></i> of the inverted pendulum by means of a "ball and tube joint". The indicator <i>G</i> is attached to the bob of the inverted pendulum.
  </figcaption>
</figure>
...
<figure>
  ...
  <figcaption>
    Figure 14. Ewing's modification of Gray's "conical-pendulum" seismometer (after Ewing, 1883a). The pendulum rotates about <i>P</i>. The member <i>A</i> is forked so that it does not touch <i>P</i>. From the left end of <i>A</i> a flat steel spring comes back to <i>P</i>.
  </figcaption>
</figure>
...
<figure class='left'>
  ...
  <figcaption>
    Figure 15. Elastic waves from dynamite explosions (reproduced from <i>Trans. Seis. Soc.</i> Japan, <b>8</b>). The distance of each station from an explosion of three pounds of dynamite is given. Time marks are put on every half second. The experiments were carried out in 1881.
  </figcaption>
</figure>
...
<figure class='right'>
  ...
  <figcaption>
    Figure 17. Oddone's strain-measuring seismometer (adapted from Oddone, 1900). A recording device, which was intended to record the rise and fall of the water in the tube <i>C</i>, is not shown.
  </figcaption>
</figure>
...
<h2 id='international'>The Seismograph Becomes an International Instrument</h2>
<p>
...
<figure class='left'>
  ...
  <figcaption>
    Figure 18. One of the first known recordings of a distant earthquake, obtained with von Rebeur's horizontal pendulum (reproduced from <i>Nature</i>, <b>40</b>, 1889, p. 295).
  </figcaption>
</figure>
...
<figure>
  ...
  <figcaption>
    Figure 20. A Japanese earthquake recorded in Italy on a Cancani common-pendulum seismograph (reproduced from <i>Atti. Accad. naz. Lincei Rc.</i> vol. 3, ser. 5, sem. 1, 1894, p. 554).
  </figcaption>
</figure>
...
<figure>
  ...
  <figcaption>
    Figure 23. A record obtained with a Milne horizontal seismograph on April 5 1901 (reproduced from <i>Rep. Bril. Ass. Advmt. Sci. 1901, </i> p. 50). As may be seen, the usefulness of Milne's instrument was diminished by its lack of damping.
  </figcaption>
</figure>
...
<h2 id='microseisms'>Early Studies of "Microseisms"</h2>
<p>
...
<figure>
  ...
  <figcaption>
    Figure 24. "Pulsatory oscillations" (period about six seconds) observed on September 6th-7th, 1898, on an Omori horizontal-pendulum seismograph in Tokyo (reproduced from <i>Journal of the College of Science, Univ. of Tokyo</i>, <b>11</b>, plate IV).
  </figcaption>
</figure>
...
<h2 id='tilt'>The Tilt Controversy</h2>
<p>
...
<figure>
  ...
  <figcaption>
    Figure 25. Schl&#252;ter's klinograph (modified from Schl&#252;ter, 1903). The frame rotates on an agate edge <i>S</i>, which rests on an agate plate, not shown. <i>S</i> is made to coincide with the frame's center of mass by adjusting the weights <i>L</i>. Light is reflected off the mirror <i>M</i> onto a moving photographic surface. The mirror is mounted so as to apply a slight restoring force to the klinograph.
  </figcaption>
</figure>
...
<h2 id='gottingen'>The G&#246;ttingen Seismographs</h2>
<p
...
<figure>
  ...
  <figcaption>
    Figure 27. Vertical-motion record obtained with Schl&#252;ter's klinograph, on September 30, 1901 (reproduced from <i>Beitrage zur Geophysik</i>, <b>5</b>. 1903, plate 2). To obtain this record, the klinograph was modified from the form shown in Figure 25 to make it sensitive to vertical displacements (see text).
  </figcaption>
</figure>
...
<ul class='referencelist'>
  <li>
    Dewey, James, Perry Byerly; <a href="https://pubs.geoscienceworld.org/bssa/article/59/1/183/101553/the-early-history-of-seismometry-to-1900">The early history of seismometry (to 1900)</a> (1969). Bulletin of the Seismological Society of America, v.59, no.1, pp. 183–227.
  </li>
</ul>
