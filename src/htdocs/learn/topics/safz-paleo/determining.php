...
<figure>
  ...
  <figcaption>
    Fault produced during large magnitude earthquake on the San Andreas Fault at Pallette Creek, California when organic rich layer 4 was at the ground surface. Note that silt and sand layer  5 is thicker on the left side of the fault, where it filled in the step (scarp) made by motion on the fault.  Layers 5 and 6 are not affected by the fault.  The age of the earthquake is determined by the age of layers above and below the fault tip. (Kate Scharer, USGS)
  </figcaption>
</figure>
