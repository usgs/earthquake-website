...
<p>
  ...
  total destruction. Although numerous <i> intensity scales</i> have been
  ...
  seismologists Harry Wood and Frank Neumann. This scale, composed of increasing
...
<p>
  The <strong>lower</strong> numbers of the intensity scale generally deal with
  the manner in which the earthquake is felt by people. The <b>higher</b>
  numbers of the scale are based on observed structural damage. Structural
  engineers usually contribute information for assigning intensity values of
  VIII or above.
</p>
<p>
  The following is an abbreviated description of the levels of Modified Mercalli
  intensity.
</p>
...
<table>
  ...
  <tr>
    <td style="background-color:#dfe6fe;">II</td>
    <td>Weak</td>
    <td>Felt only by a few persons at rest,especially on upper floors of buildings.</td>
  </tr>
  <tr>
    <td style="background-color:#82f9fb;">III</td>
    <td>Weak</td>
    <td>Felt quite noticeably by persons indoors, especially on upper floors of
...
estimated.</td>
  ...
  <tr>
    <td style="background-color:#7efbdf;">IV</td>
    <td>Light</td>
    <td>Felt indoors by many, outdoors by few during the day. At night, some
    awakened. Dishes, windows, doors disturbed; walls make cracking sound.
    Sensation like heavy truck striking building. Standing motor cars rocked
    noticeably.</td>
  </tr>
  <tr>
    <td style="background-color:#95f879;">V</td>
    <td>Moderate</td>
    <td>Felt by nearly everyone; many awakened. Some dishes, windows broken.
    Unstable objects overturned. Pendulum clocks may stop.</td>
  </tr>
  <tr>
    <td style="background-color:#f7f835;">VI</td>
    <td>Strong</td>
    <td>Felt by all, many frightened. Some heavy furniture moved; a few instances of fallen plaster. Damage slight.</td>
  </tr>
  <tr>
    <td style="background-color:#fdca2c;">VII</td>
    <td>Very strong</td>
    <td>Damage negligible in buildings of good design and construction; slight to moderate in well-built ordinary structures; considerable damage in poorly
    built or badly designed structures; some chimneys broken.</td>
  </tr>
  <tr>
  <td style="background-color:#ff701f;">VIII</td>
    <td>Severe</td>
    <td>Damage slight in specially designed structures; considerable damage in
    ordinary substantial buildings with partial collapse. Damage great in poorly
    built structures. Fall of chimneys, factory stacks, columns, monuments, walls. Heavy furniture overturned.</td>
  </tr>
  <tr>
    <td style="background-color:#ec2516;">IX</td>
    <td>Violent</td>
  ...
  <tr>
    <td style="background-color:#c81e11;">X</td>
    <td>Extreme</td>
    <td>Some well-built wooden structures destroyed; most masonry and frame
    structures destroyed with foundations. Rails bent.</td>
  </tr>
  </tbody>
</table>
...
<h2>History and Details of MMI</h2>

<p>
  The following is an excerpt from <a href="https://pubs.usgs.gov/of/1995/0092/report.pdf">Intensity Distribution and Isoseismal Maps for the Northridge, California, Earthquake of January 17,1994.</a>
</p>
...
<ul class="referencelist">
  <li>
    Dewey, James, B. Glen Reagor, L. Dengler, K. Moley (1995). Intensity Distribution and Isoseismal Maps for the Northridge, California, Earthquake of January 17,1994, USGS Open-File Report 95-92.
  </li>
  <li>
  ...
  <li>
    Wood, H. O., and Neumann, Frank (1931). Modified Mercalli Intensity Scale of 1931: Seismological Society of America Bulletin, v. 21, no. 4, p. 277-283.
  </li>
</ul>
