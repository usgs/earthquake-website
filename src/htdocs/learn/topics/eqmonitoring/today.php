<?php
      ...
      if	(!isset($TEMPLATE))	{
      $TITLE	=	'Earthquake Monitoring Today';
      $NAVIGATION	= true;
      include	'template.inc.php';
      }
?>
<!--<h2>EQ Monitoring Today </h2>-->
<p>
...
<p>
	<a href = "images/p2.gif"> <img src = "images/p2_sm.gif" alt="Image of a K2 accelerometer and recorder."/></a>
</p>
<p>
...
<p>
	<a href = "images/p3.gif"> <img src = "images/p3_sm.gif" alt="Image of a K2 instalation"/></a>
</p>
<p>
...
<p>
	<a href = "images/p6.gif"> <img src = "images/p6_sm.gif" alt="Image of the internal componets of the K2 accelerometer."/></a>
</p>
<h3>The Central Site Data Acquisition System</h3>
<p>
...
<p>
	<a href = "images/p4.gif"> <img src = "images/p4_sm.gif" alt="image of the Central data acquisition system."/></a>
</p>
...
<p>
	<img src="images/fba23_lowres.jpg" alt="Photo of the FBA-23 Force Balance Accelerometer used to measure the acceleration of the ground as it is shaking during an earthquake. "/>
</p>
<p>
	<strong>STS-1</strong><br />
...
<p>
	<img src="images/sts1_lowres.jpg" alt="Photo of the STS-1 a state-of-the art seismometer."/>
</p>
<p>
	<strong>Episensor</strong><br />
...
<p>
	<img src="images/episensor_lowres.jpg" alt="Photo of the Episensor a newer version of the FBA-23. It records ground acceleration much more accurately and with greater sensitivity."/>
</p>
<!--
<hr />
<div align="center">
	<a href="eq-mon-8.php">Previous Page</a>
	<a href="eq-mon-10.php">Next Page</a>
	<br />
