<?php
      ...
      if	(!isset($TEMPLATE))	{
      $TITLE	=	'Earthquake Facts & Earthquake Fantasy';
      $NAVIGATION	= true;
...
<figure class="right">
	<img src="images/brokenearth.jpg" alt="broken earth cartoon"/>
</figure>

<h3>FACT: Earthquakes are sudden rolling or shaking events caused by movement under the Earth&#8217;s surface.</h3>
<p>
...
<h3>FICTION: &#8220;Mega Quakes&#8221; can really happen.</h3>
<p>
...
<h3>FICTION: The 1906 San Francisco earthquake was the deadliest ever.</h3>
<p>
...
<h3>PARTIALLY FACT: California has the most earthquakes in the United States.</h3>
<p>
...
<h3>FACT: Earthquakes can occur near the surface or deep below the surface.</h3>
<p>
...
<h3>FICTION: The ground can open up during an earthquake.</h3>
<p>
...
<h3>NOT LIKELY: Two major earthquakes occurred on the same day, so they must be related.</h3>
<p>
...
<h3>PARTIALLY FACT: People can cause earthquakes.</h3>
<p>
...
<p>
  See also: <a href="/research/induced/">USGS Induced Earthquakes Research</a>
</p>
...
<h3>FICTION: Nuclear explosions can start or stop earthquakes.</h3>
<p>
...
<h3>FICTION: Animals can predict earthquakes.</h3>
<p>
...
<h3>MAYBE: Some people can sense that an earthquake is about to happen.</h3>
<p>
...
<h3>FICTION: It&#8217;s been raining a lot, or very hot--it must be earthquake weather!</h3>
<p>
...
<h3>FICTION: During an earthquake you should head for the doorway.</h3>
<p>
...
<h3>FICTION: You can&#8217;t plan ahead for an earthquake.</h3>
<p>
  There are plenty of things you can do right now to prepare if you live in an earthquake-prone area.<br />
	<ol>
  	<li>Make sure each member of your family knows what to do no matter where they are when earthquakes occur:
			<ul>
				<li>Establish a meeting place where you can all reunite afterward.</li>
  			<li>Find out about earthquake plans developed by children's school or day care.</li>
  			<li>Remember transportation may be disrupted, so keep some emergency supplies--food, liquids, and comfortable shoes, for example--at work.</li>
			</ul>
		</li>
		<li>KNOW where your gas, electric and water main shutoffs are and how to turn them off if there is a leak or electrical short. Make sure older members of the family can shut off utilities.</li>
  	<li>LOCATE your nearest fire and police stations and emergency medical facility.</li>
  	<li>TALK to your neighbors--how could they help you, or you them after an earthquake?</li>
  	<li>TAKE Red Cross First Aid and CPR Training Course.</li>
  	<li>MAKE your disaster supply kit. Beyond the usual flashlights, batteries and radios, include a first-aid kit; work gloves; sturdy shoes or boots; a week&#8217;s supply of any presciption medications you or your family might need; credit card and cash; personal identifcation; extra set of keys; matches in a waterproof container; map of your area; phone numbers of family and other important people (doctors, veterinarians, etc.); copies of insurance policies and other important documents; special needs equipment (diapers, baby formula, hearing aid batteries; spare eyeglasses, etc.); three gallons of water per person; three-day supply of food per person; hand tools; a portable ABC fire extinguisher; sanitation supplies for you and your family; entertainment (toys, books, coloring books and crayons, playing cards)</li>
  	<li>BOLT bookcases, china cabinets, tall furniture, file cabinets, etc. to wall studs. Brace or anchor heavy electronics and other heavy items. Secure items that might fall. Move heavy or fragile items to lower shelves. Fasten drawers and cabinet doors with latches or locks. Brace overhead light fixtures. Strap your water heater to wall studs and bolt down any gas appliances. Look for other non-structural steps you can take in your home and workplace to reduce your chances for injury and loss.</li>
  	<li>ASK AN ENGINEER about the seismic safety of your home and/or business. It&#8217;s well known that unreinforced masonry structures can fail quickly during earthquakes. An inspection by a structural engineer now can help you decide if retrofitting will help your property withstand shaking.</li>
	</ol>
</p>

<figure class="left">
	<img class="left" src="images/lomaprieta_damage.jpg" alt="Lomaprieta Damage"/>
</figure>
