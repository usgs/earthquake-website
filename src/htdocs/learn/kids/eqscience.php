...
<p class="disclaimer">
  <small>
  Originally written by Lisa Wald for &ldquo;The Green Frog News&rdquo;
  </small>
</p>

<h3>What is an earthquake?</h3>
<figure class="right">
  <img src="images/fault_labeled.gif" alt="labeled fault"/>
</figure>
<p>
  An <em>earthquake</em> is what happens when two blocks of the earth suddenly
  slip past one another. The surface where they slip is called the
  <em>fault</em> or<em> fault plane</em>. The location below the earth&rsquo;s
  surface where the earthquake starts is called the <em>hypocenter</em>, and
  the location directly above it on the surface of the earth is called the
  <em>epicenter</em>.
</p>

<p>
  Sometimes an earthquake has <em>foreshocks</em>. These are smaller
  earthquakes that happen in the same place as the larger earthquake that
  follows. Scientists can&rsquo;t tell that an earthquake is a foreshock until
  the larger earthquake happens. The largest, main earthquake is called the
  <em>mainshock</em>. Mainshocks always have <em>aftershocks</em> that follow.
...
<h3>What causes earthquakes and where do they happen?</h3>
<figure class="right">
  <img src="images/core_fourcolumn.gif" alt="Earth cross-section"/>
</figure>
<p>
  The earth has four major layers: the <em>inner core, outer core, mantle</em>
  and <em>crust</em>. (figure 2) The crust and the top of the mantle make up a
  thin skin on the surface of our planet. But this skin is not all in one piece
  &ndash; it is made up of many pieces like a puzzle covering the surface of
  ...
  these puzzle pieces <em>tectonic plates</em>, and the edges of the plates are
  called the <em>plate boundaries</em>. The plate boundaries are made up of
...
<h3>Why does the earth shake when there is an earthquake?</h3>
<figure class="left">
  <img src="images/plate_tectonics_fourcolumn.gif" alt="tectonic plates"/>
</figure>
<p>
  ...
  overcomes the <em>friction</em> of the jagged edges of the fault and it
  unsticks, all that stored up energy is released. The energy radiates outward
  from the fault in all directions in the form of <em>seismic waves</em> like
  ripples on a pond. The seismic waves shake the earth as they move through it,
  and when the waves reach the earth&rsquo;s surface, they shake the ground and
  anything on it, like our houses and us! (see P&amp;S Wave inset)
</p>

<h3>How are earthquakes recorded?</h3>
<figure class="right">
  <img src="../glossary/images/seismograph.jpg" alt="seismograph"/>
</figure>
<p>
  Earthquakes are recorded by instruments called <em>seismographs</em>. The
  recording they make is called a <em>seismogram</em>. (figure 4) The
...
<h3>How do scientists measure the size of earthquakes?</h3>
<p>
  The size of an earthquake depends on the size of the fault and the amount of
  slip on the fault, but that&rsquo;s not something scientists can simply
  measure with a measuring tape since faults are many kilometers deep beneath
  the earth&rsquo;s surface. So how do they measure an earthquake? They use the
  <em>seismogram</em> recordings made on the <em>seismographs</em> at the
  surface of the earth to determine how large the earthquake was (figure 5). A
  short wiggly line that doesn&rsquo;t wiggle very much means a small
...
<figure class="left">
  <img src="images/seismogram_fourcolumn.gif" alt="seismogram"/>
</figure>
<p>
  The size of the earthquake is called its <em>magnitude</em>. There is one
  magnitude for each earthquake. Scientists also talk about the
  <em>intensity</em> of shaking from an earthquake, and this varies depending
  on where you are during the earthquake.
</p>

<h3>How can scientists tell where the earthquake happened?</h3>
<figure class="right">
  <img src="images/seismic_waves.gif" alt="P &amp; S waves"/>
</figure>
<p>
  Seismograms</em> come in handy for locating earthquakes too, and being able
  to see the <em>P wave</em> and the <em>S wave</em> is important. You learned
  ...
  let&rsquo;s compare P and S waves to lightning and thunder. Light travels
...
<p>
  ...
  However, they can&rsquo;t tell in what direction from the seismograph the
  earthquake was, only how far away it was. If they draw a circle on a map
  around the station where the <em>radius</em> of the circle is the determined
  distance to the earthquake, they know the earthquake lies somewhere on the
  circle. But where?
</p>

<figure class="right">
  <img src="images/triangulation.gif" alt="triangulation"/>
</figure>
<p>
  Scientists then use a method called <em>triangulation</em> to determine
  ...
  seismographs where the <em>radius</em> of each is the distance from that
  station to the earthquake, the intersection of those three circles is the
  <em>epicenter</em>!
</p>

<h3>Can scientists predict earthquakes?</h3>
<p>
