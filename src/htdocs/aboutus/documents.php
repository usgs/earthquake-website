...
<ul class='no-style separator'>
  ...
  <li>
    <a href="/learn/publications/pubs_factsheets.php">Earthquake-related Fact Sheets</a>
  </li>
  <li>
    <a href="/learn/publications/pubs_geninfo.php">Earthquake-related General Interest Publications</a>
  </li>
</ul>
