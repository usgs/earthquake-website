...
<p>
	...
	<ol>
		<li><a href="/static/lfs/data/gsn/ttpicks_raw.txt">raw arrival time picks in tabular form</a>: The columns of this file are, respectively, station name, channel name, and year, day, hour, minute, and second of the phase pick. </li>

		<li><a href="/static/lfs/data/gsn/ttpicks.txt">"associated" arrival time picks in tabular form</a>: The columns of this file are, respectively, station name, channel name, year, day, hour, minute, and second of the phase pick, year, day, hour, minute, second, latitude, longitude, depth (km) of the associated earthquake, and the phase association.</li>
	</ol>
</p>
