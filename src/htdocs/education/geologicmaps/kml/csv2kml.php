...
foreach ($lines as $line_num => $line) {
  ...
  if ($count != 1) { // Skip header line
    ...
    $options = "";
    if (preg_match('/YES/', $layer_apfaults)) $options .= "				<tr><td><a href=\"https://earthquake.usgs.gov/education/geologicmaps/kml/AP_Faults/APFaults_$filename.kmz\"><img src=\"quads/ge.gif\" border=\"0\"></a></td><td><a href=\"https://earthquake.usgs.gov/education/geologicmaps/apfaults.php\"><img src=\"quads/info.gif\" border=\"0\"></a></td><td>Alquist-Priolo Faults</td></tr>\n";
    if (preg_match('/YES/', $layer_eqs)) $options .= "				<tr><td><a href=\"https://earthquake.usgs.gov/education/geologicmaps/kml/Historic_Eqs/Hist_Eqs_$filename.kmz\"><img src=\"quads/ge.gif\" border=\"0\"></a></td><td><a href=\"https://earthquake.usgs.gov/education/geologicmaps/earthquakes.php\"><img src=\"quads/info.gif\" border=\"0\"></a></td><td>Earthquakes</td></tr>\n";
    if (preg_match('/YES/', $layer_geology)) $options .= "				<tr><td><a href=\"https://earthquake.usgs.gov/education/geologicmaps/kml/Geology/Geology_$filename.kmz\"><img src=\"quads/ge.gif\" border=\"0\"></a></td><td><a href=\"https://earthquake.usgs.gov/education/geologicmaps/geology.php\"><img src=\"quads/info.gif\" border=\"0\"></a></td><td>Geology</td></tr>\n";
    if (preg_match('/YES/', $layer_hillshades)) $options .= "				<tr><td><a href=\"https://earthquake.usgs.gov/education/geologicmaps/kml/Hillshades/Hillshade_$filename.kmz\"><img src=\"quads/ge.gif\" border=\"0\"></a></td><td><a href=\"https://earthquake.usgs.gov/education/geologicmaps/hillshades.php\"><img src=\"quads/info.gif\" border=\"0\"></a></td><td>Hillshades</td></tr>\n";
    if (preg_match('/YES/', $layer_landslides)) $options .= "				<tr><td><a href=\"https://earthquake.usgs.gov/education/geologicmaps/kml/Landslides/Landslides_$filename.kmz\"><img src=\"quads/ge.gif\" border=\"0\"></a></td><td><a href=\"https://earthquake.usgs.gov/education/geologicmaps/landslides.php\"><img src=\"quads/info.gif\" border=\"0\"></a></td><td>Landslides</td></tr>\n";
    if (preg_match('/YES/', $layer_liquefac)) $options .= "				<tr><td><a href=\"https://earthquake.usgs.gov/education/geologicmaps/kml/Liquefaction/Liquefaction_$filename.kmz\"><img src=\"quads/ge.gif\" border=\"0\"></a></td><td><a href=\"https://earthquake.usgs.gov/education/geologicmaps/liquefaction.php\"><img src=\"quads/info.gif\" border=\"0\"></a></td><td>Liquefaction Susceptibility</td></tr>\n";
    if (preg_match('/YES/', $layer_qfaults)) $options .= "				<tr><td><a href=\"https://earthquake.usgs.gov/education/geologicmaps/kml/Q_Faults/QFaults_$filename.kmz\"><img src=\"quads/ge.gif\" border=\"0\"></a></td><td><a href=\"https://earthquake.usgs.gov/education/geologicmaps/qfaults.php\"><img src=\"quads/info.gif\" border=\"0\"></a></td><td>Quaternary Faults</td></tr>\n";
