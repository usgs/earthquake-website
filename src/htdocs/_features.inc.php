...
$EQ_FEATURES->items[] = array(
	...
	'content' => '<span class="mobile icon-mobile-friendly"></span>' .
	...
	'featureImage' => 'images/mapinterface.gif',
	'publish' => strtotime('2014-11-01')
);

$EQ_FEATURES->items[] = array(
	'id' => 'earthquake_swarm_nevada',
...
$EQ_FEATURES->items[] = array(
	...
	'modified' => strtotime('2014-11-01'),
	'featureImage' => 'images/the-great-shakeout-oct-16-2014.gif'
);
...
$EQ_FEATURES->items[] = array(
	...
	'modified' => strtotime('2014-11-01'),
	'featureImage' => 'images/seismometers-to-measure-dc-shaking.jpg'
);
