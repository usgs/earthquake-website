...
<h2>Send general queries or comments to</h2>
<h2>Brian Sherrod or Joan Gomberg</h2>

<p>
  bsherrod@usgs.gov, gomberg@usgs.gov<br/>
...
<p>
  <a href="http://www.washington.edu/home/maps/">
  University of Washington Campus Map &amp; Directions</a>
</p>
<p>
  <a href="http://www.pnsn.org/contact-us/directions-and-parking/">
  Map &amp; Directions to the PNSN Lab</a>
</p>

<h2>USGS Seattle Staff</h2>
<ul class='no-style'>
  <li>
    <h3>Brian Atwater</h3>
    <img class='staff' src="images/atwater-brian.jpg" alt="">
    <p class='staff-desc'>
  ...
  <li>
    <h3>David Bowen</h3>
    <img class='staff' src="images/bowen-david.jpg" alt="">
    <p class='staff-desc'>
  ...
  <li>
    <h3>Art Frankel</h3>
    <img class='staff' src="images/frankel-arthur.jpg" alt="">
    <p class='staff-desc'>
  ...
  <br style="clear:left;"/>
  <li>
    <h3><a href="https://www.usgs.gov/staff-profiles/joan-gomberg">Joan Gomberg</a></h3>
    <img class='staff' src="images/gomberg-joan.jpg" alt="">
    <p class='staff-desc'>
  ...
  <br style="clear:left;"/>
  <li>
    <h3>Ralph Haugerud</h3>
    <img class='staff' src="images/haugerud-ralph.jpg" alt="">
    <p class='staff-desc'>
  ...
  <li>
    <h3>Tim Jurgensen</h3>
    <img class='staff' src="images/jurgensen-tim.jpg" alt="">
    <p class='staff-desc'>
  ...
  <br style="clear:left;"/>
  <li>
    <h3><a href="https://www.usgs.gov/staff-profiles/kristin-ludwig">Kristin Ludwig</a></h3>
    <img class='staff' src="images/ludwig-kristin.png" alt="">
    <p class='staff-desc'>
      Kris is a staff scientist in the USGS Natural Hazards Mission Area and an affiliate assistant professor in the Department of Earth and Space Sciences at the University of Washington. She is part of the Department of the Interior Strategic Sciences Group (SSG), which was created in 2012 to support decision making during environmental crises affecting Departmental resources. Kris has co-authored the USGS’s &ldquo;Reducing Risk Where Tectonic Plates Collide &ndash; A Plan to Advance Subduction Zone Science&CloseCurlyDoubleQuote; and &ldquo;Science for a risky world&mdash; A U.S. Geological Survey plan for risk research and applications&CloseCurlyDoubleQuote;.
    </p>
  </li>
  <br style="clear:left;"/>
  <li>
    <h3>Colin O'Rourke</h3>
    <img class='staff' src="images/orourke-colin.jpg" alt="">
    <p class='staff-desc'>
  ...
  <br style="clear:left;"/>
  <li>
    <h3>Brian Sherrod (PNW Coordinator)</h3>
    <img class='staff' src="images/sherrod-brian.png" alt="">
    <p class='staff-desc'>
  ...
  <li>
    <h3>Lynn Simmons</h3>
    <img class='staff' src="images/simmons-lynn.jpg" alt="">
    <p class='staff-desc'>
  ...
  <li>
    <h3>Erin Wirth</h3>
    <img class='staff' src="images/wirth-erin.png" alt="">
    <p class='staff-desc'>
  ...
  <li>
    <h3>Tom Yelin</h3>
    <img class='staff' src="images/yelin-tom.jpg" alt="">
    <p class='staff-desc'>
  ...
  <br style="clear:left;"/>
  <li>
    <h3>Brett Zimmerman</h3>
    <img class='staff' src="images/zimmerman-brett.jpg" alt="">
    <p class='staff-desc'>
