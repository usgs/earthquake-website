...
<nav class="jumplist">
	...
	<a href="#ceus">Central and Eastern US</a>
	<a href="#pacnw">Pacific Northwest</a>
</nav>
...
<ul class="no-style linklist">
  ...
  <li>
    ...
    <p>
      ...
      plotted on the <a href="/hazards/hazmaps/conterminous/">2014 USGS National
      Seismic Hazard Map for the central and eastern United States</a>. Warmer
      colors on this map indicate areas of higher hazard. Larger earthquakes are
      represented by larger circles. (PDF)
    </p>
  </li>
  <li>
...
<h2 id="pacnw">Pacific Northwest</h2>
<ul class="no-style linklist">
  <li>
    <a href="seattle.php">
    ...
    <p>
      ...
      of earthquake hazard maps for the City of Seattle. These &ldquo;urban
      seismic hazard&rdquo; maps provide a much higher-resolution view of the
