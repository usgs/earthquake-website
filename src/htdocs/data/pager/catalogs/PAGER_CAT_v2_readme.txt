...
Allen, T.I., Marano, K.D., Earle, P.S., and Wald, D.J. (in press). PAGER-CAT: A composite earthquake
...
To get started, type "load PAGER_CAT_v2" in your working directory.  This will load the variable
