  ...
  <div class="column three-of-five">
    ...
    <ul class="linklist">
      ...
      <li>
        ...
        <p>The Atlas of ShakeMaps (Version 1.0, ~1000 events) provides a consistent and quantitative description of the distribution of shaking intensity for calibrating global earthquake loss estimation methodologies used in PAGER. (catalog=atlas; date=1900-2015)</p>
      </li>
