...
<ul class="no-style separator linklist">
 <li class="first"><a name="3DFM" id="3DFM"></a>
  <h2>3D focal mechanisms</h2>
               <a href="http://pubs.usgs.gov/ds/2007/241/"><img class="left" src="images/3DFM.jpg" alt="3DFM Logo" width="146" height="75" /></a>
 ...
 <li><a name="3D" id="3D"></a>
  <h2>3D velocity modeling</h2>
              ...
              <p>Fortran code (VMS compatible) for 3-D velocity model determination and hypocentral location with local earthquake data. Full
                    inversion, not tomography, this is the program written by
                    Cliff Thurber and modified by others.</p>
  </li>

<li><a name="github-devcorner" id="github-devcorner"></a>
	<h2>ANSS Developer&rsquo;s Corner</h2>
	<a href="https://github.com/usgs/devcorner">
  <img src="images/githubdev.gif" class="left" alt="github logo"></a>
	<table cellspacing="1" class="tabular">
		<tr>
			<th>Authors:</th>
			<td>various</td>
	...
	<p>A github repository for different software tools to access the ComCat (Comprehensive Earthquake Catalog) data. Contributions are welcome and encouraged.
	</p>
</li>

 <li><a name="cleanstrain+" id="cleanstrain+"></a>
  <h2>cleanstrain+</h2>
              <img class="left" src="images/cleanstrain.gif" alt="Cleanstrain+ Logo" width="146" height="99" />
              <table cellspacing="1" class="tabular">
                <tr>
                  <th>Author:</th>
              ...
              <p>Cleanstrain+ is a program to process strainmeter data. This code will simultaneously estimate the tidal constituents, pressure admittance, offsets, rate changes, and other terms using least-squares but, importantly, incorporating the temporally correlated nature of strain data (that is, the power spectra is  red).</p>
           </li>



 <li><a name="CLUSTER" id="CLUSTER"></a>
  <h2>CLUSTER2000</h2>
              <img class="left" src="images/clusters.jpg" alt="Cluster Logo" width="120" height="125" />
              <table cellspacing="1" class="tabular">
                <tr>
                  <th>Author:</th>
                ...
                <tr>
                  ...
                  <td>Comments in source code</td>
							 ...
							 <tr>
                  <th>Download:</th>
                  <td><a href="ftp://ehzftp.wr.usgs.gov/cluster2000/cluster2000x.f">Fortran
                    source code</a> (35k), <a href="ftp://ehzftp.wr.usgs.gov/cluster2000/Makefile">Makefile</a> (233b)</td>
                </tr>

              </table>
              <p>CLUSTER2000 recognizes clusters in space-time in an earthquake
 ...
 <li><a name="Coulomb" id="Coulomb"></a>
  <h2>Coulomb 3</h2>

              <a
				  href="coulomb/"><img
				  class="left" src="images/coulomb3.jpg" alt="Coulomb Logo" width="150" height="99" /></a>
              <table cellspacing="1" class="tabular">
                <tr>
                  <th>Authors:</th>
              ...
              <p>Coulomb 3 is designed to investigate Coulomb stress changes on mapped faults
              and earthquake nodal planes, and is intended both for publication-directed
              research and for university teaching and instruction.</p>
              <p>One can calculate static displacements (on any surface or at GPS stations),
              ...
              isotropic elastic properties following Okada [1992].</p>
              <p>We believe that one learns best when one can see the most and can explore
           ...
           <li>
             <a name="DGRFN"></a>
             <h2>Direct Green&rsquo;s Function Synthetic Seismograms</h2>
             <a href="/research/software/DGRFN/DGRFN.tar"><img class="left" src="images/DGRFN.png" alt="Logo" width="144" height="104" /></a>
             <table class="tabular">
               <tr>
                 <th>Author:</th>
               ...
               <tr>
                 <th>Download:</th>
                  <td><a href="/research/software/DGRFN/DGRFN.tar">DGRFN.tar</a> (1.6 MB)</td>
               </tr>
             </table>
             <p>These programs are an implementation of the Direct Green&rsquo;s Function method
...
a zero-traction boundary condition at Earth&rsquo;s surface, and a homogeneous isotropic
elastic solid at the base of the specified Earth model. The computation of synthetics is stable at both high and low frequencies,
as well as at high and low spherical harmonic degrees.</p>
           </li>
...
<li>
	...
	<a href="gmpe/GK2015_GMPE.zip"><img src="gmpe/gmpe.png" alt="logo" class="left" width="150" /></a>
	<table cellspacing="1" class="tabular">
		<tr>
			<th>Authors:</th>
		...
		<tr>
			<th>Manual:</th>
			<td>Comments in source code; <a href="http://pubs.usgs.gov/of/2015/1009/">Open-File Report</a> and <a href="gmpe/2016_Graizer_Kalkan_BSSA.pdf">BSSA article</a></td>
		</tr>
		<tr>
			<th>Download:</th>
			<td><a href="gmpe/GK2015_GMPE.zip">GK15_GMPE.zip</a> (5 Kb)</td>
		</tr>
	</table>
              ...
              <table cellspacing="1" class="tabular">
                ...
                <tr>
                  ...
                  <td>PDF included in download file</td>
							 ...
							 <tr>
                  <th>Download:</th>
                  <td><a href="/research/software/HASH/hash.v1.2.tar.gz">hash.v1.2.tar.gz</a> (1 MB)</td>
                </tr>
              </table>
 ...
 <li><a name="MacR1D" id="MacR1D"></a>
  ...
  <img class="left" src="images/MacR1D.gif" alt="Ray Tracing Logo" width="120" height="119" />
              <table cellspacing="1" class="tabular">
                ...
                <tr>
                  <th>Download:</th>
                  <td><a href="MacR1D/MacR1D-V1.17-Executables.tar.gz">MacR1D V1.17</a></td>
                </tr>
              </table>
...
<li><a name="Ray" id="Ray"></a>
  <h2>MacRay</h2>
              ...
              <table cellspacing="1" class="tabular">
                ...
                <tr>
                  <th>Download:</th>
                  <td>Mac OS X - <a href="MacRay/MacRay-V2.29-Executables.tar.gz">MacRay V2.29</a> (3.7 MB); PC - <a HREF="ftp://ehzftp.wr.usgs.gov/luetgert/software/Macintosh_Software/RAY84PC.zip">RAY84PC</a> (1.2 MB)</td>
                </tr>
              </table>
...
Nitin Gupta (USC/SCEC), Vipin Gupta (USC/SCEC), Peter Powers, Kevin Miner, and others.</td>
           ...
           <li>
             ...
             <table cellspacing="1" class="tabular">
               ...
               <tr>
                 <th>Download:</th>
                 <td><a href="phasepicker/PPhasePicker.zip">PphasePicker.zip</a> (8.6 Mb)</td>
               </tr>
             </table>
              ...
              <table cellspacing="1" class="tabular">
                ...
                <tr>
                  ...
                  <td>Included in download file</td>
							 ...
							 <tr>
                  <th>Download:</th>
                  <td><a href="satsi/SATSI_140818.tar.gz">SATSI_140818.tar.gz</a> (63k)</td>
                </tr>
              </table>
 ...
 <li><a name="SLAMMER" id="SLAMMER"></a>
  <h2>SLAMMER - Seismic Landslide Movement Modeled using Earthquake Records</h2>
           ...
           <li>
             ...
             <h2>STATIC1D</h2>
			 <a href="STATIC1D/STATIC1D.tar.gz"><img class="left" src="STATIC1D/STATIC1D.png" width="144" height="131" alt="icon" /></a>
             <table cellspacing="1" class="tabular">
               <tr>
                 <th>Author:</th>
                 <td><a href="mailto:fpollitz@usgs.gov">Fred Pollitz</a></td>
               ...
               <tr>
                 <th>Download:</th>
                 <td><a href="STATIC1D/STATIC1D.tar.gz">STATIC1D.tar.gz</a></td>
               </tr>
             </table>
