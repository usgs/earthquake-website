...
<figure class='right'>
	<img src="images/backhoe.jpg" alt="backhoe at trenchsite"/></a>
	<figcaption>Corner Canyon site trench excavation. Photo by Scott Bennett, 2014.</figcaption>
</figure>
...
<h2>Selecting and Preparing the Site</h2>
<p>
...
<figure class='left'>
	<img src="images/grid.jpg" alt="gridding the trenchsite"/></a>
	<figcaption>
...
<figure class='left'>
	<img src="images/select.jpg" alt="example of site before trench excavation"/></a>
	<figcaption>
...
<h2>Interactive 3-D Model of Alpine Trench</h2>

<figure class='left model'>
	<a href="3Dmodel-AlpineTrench.pdf">
    <img style="margin-left:0;" src="images/3dtrench.gif" alt="3dtrench"/>
  </a>
</figure>

<p>
  <a href="3Dmodel-AlpineTrench.pdf">Download and interact with 3-D model of the Alpine trench.</a><br/>
  (6.3MB PDF, <a href="http://get.adobe.com/reader/">Adobe Reader</a> required).
</p>
...
<h2 class="clear">Time-lapse Video of Flat Canyon Trench Excavation</h2>
<p>
<video src="FlatCynExcavation.mp4" poster="images/poster.jpg" controls="controls" width="720" height="565"></video>
</p>
<p>by Scott Bennett</p>

<!-- NAVIGATION at bottom for ARTICLE -->
<p>
  <a class='prev' href="doing.php">
    <span class='material-icons prev'>&#xe5c4;</span>
    <strong>PREV</strong>
  </a>
  <a class='next' href="collect.php">
    <strong>NEXT</strong>
