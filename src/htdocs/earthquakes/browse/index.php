  ...
  <div class="column one-of-three">
    ...
    <div class="alert">
      ...
      <ul class="no-style">
        ...
        <li>
          <a href="/earthquakes/states/10_largest_us.php">Top 20 Largest Earthquakes</a>
        </li>
        <li>
      ...
      <ul class="no-style">
        ...
        <li>
          <a href="/earthquakes/world/10_largest_world.php">Top 17 Largest Earthquakes</a>
        </li>
        <li>
        ...
        <li>
          <a href="specialstudies.php">Special Earthquake Studies</a>
        </li>
      </ul>
    </div>
  </div>
