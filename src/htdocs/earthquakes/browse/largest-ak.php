<?php
  ...
  if (!isset($TEMPLATE)) {
  $TITLE = '15 Largest Earthquakes in Alaska, U.S. (1900 to Present)';
  $NAVIGATION = true;
...
<div class="horizontal-scrolling">
  <table>
    ...
    <tr>
      <td><b>5.</b></td>
      <td>8.3</td>
      <td><a href="/earthquakes/eventpage/iscgem16957912">Rat Islands, Aleutian Islands, Alaska</a></td>
      <td></td>
      <td>1906-08-17</td>
      <td>00:11</td>
      <td>51.85&deg;N</td>
    ...
    <tr>
      <td><b>7.</b></td>
      <td>7.9</td>
      <td><a href="/earthquakes/eventpage/usc000rki5">SE of Little Sitkin Island, Alaska</a></td>
      <td></td>
      <td>2014-06-23</td>
      <td>20:53</td>
      <td>51.85&deg;N</td>
...
<p class='alert warning'>
  Differing magnitudes and locations have been computed for some of these earthquakes; the values differ according to the methods and data used. The magnitudes, times, and locations in this list are considered to be the best available. The data in the list above may not currently match the data on the specific eventpages in the ComCat earthquake catalog since we are actively gathering catalog data from many sources and still flagging the authoritative data.
</p>
