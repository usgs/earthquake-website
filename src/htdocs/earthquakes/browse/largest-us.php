<?php
  ...
  // Contact: Paul Earle,
  if (!isset($TEMPLATE)) {
  $TITLE = '20 Largest Earthquakes in the United States';
  $NAVIGATION = true;
...
<div class="horizontal-scrolling">
  <table>
    ...
    <tr>
      <td><b>1.</b></td>
      <td>9.2</td>
      <td><a href="/earthquakes/events/alaska1964/">Southern Alaska</a></td>
    ...
    <tr>
      ...
      <td>Hilea, SE Hawaii, Hawaii</td>
      <td>1868-04-03</td>
      <td>02:25</td>
      <td>19.2&deg;N</td>
      <td>155.5&deg;W</td>
      <td>Klein &amp; Wright, 2000</td>
    </tr>
    <tr>
      <td><b>13.</b></td>
      <td>7.9</td>
...
<h2>Note</h2>
<p>
  Differing magnitudes and locations have been computed for some of these earthquakes; the values differ according to the methods and data used. The magnitudes and exact times in the list above may not currently match the magnitudes and times on the specific eventpages in the ComCat earthquake catalog since we are actively gathering catalog data from many sources and still flagging the authoritative data.
</p>
...
<ul class='referencelist'>
  ...
  <li>
    Bakun, W.H. and M.G. Hopper, 2004, Magnitudes and locations of the 1811-1812 New Madrid, Missouri, and the 1886 Charleston, South Carolina, earthquakes, Bull. Seismol. Soc. Am., 94, p. 64-75.
  </li>
  <li>
    Grant, L.B. and K.E. Sieh, 1993, Stratigraphic evidence for seven meters of dextral slip on the San Andreas fault during the 1857 earthquake in the Carrizo Plain, Bull. Seism. Soc. Am., 83, 619-635.
  </li>
  <li>
    Hough, S.E., J.G. Armbruster, L. Seeber, and J.G. Hough, 2000, On the Modified Mercalli intensities and magnitudes of the 1811-1812 New Madrid earthquakes, J. Geophys. Res., 105, 23,839-23,864.
  </li>
  <li>
