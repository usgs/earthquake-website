<?php
  ...
  "<section>",
    ...
    navItem("${section}/1989lomaprieta/", "M6.9 October 17, 1989 Loma Prieta Earthquake") .
    navItem("${section}/alaska1964/", "The Great M9.2 Alaska Earthquake and Tsunami of March 27, 1964") .
    navItem("${section}/1906calif/", "M7.9 April 18, 1906 San Francisco Earthquake") .
    navItem("${section}/1868calif/", "M6.8 October 21, 1868 Hayward Fault Earthquake") .
