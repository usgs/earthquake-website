<?php
  if (!isset($TEMPLATE)){
    $TITLE='Archive: M6.8 October 21, 1868 Hayward Fault Earthquake';
...
<p>This list of resources is an <strong>archive</strong> of previous features.
  <a href="./">View the list of current resources</a>.</p>


<h2 id="products">New Science and Products</h2>
