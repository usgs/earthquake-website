  ...
  <div class="column four-of-five">
    <figure>
      ...
      <p class="kml"><a href="kml/Liquefaction_SanFrancisco.kmz">Liquefaction Susceptibility in San Francisco</a> <?php print(simpleFileSize("kml/Liquefaction_SanFrancisco.kmz")); ?></p>
        <figcaption>This Liquefaction Susceptibility layer is intended solely as an educational tool.  The <a href="http://www.conservation.ca.gov/cgs/shzp/">California Geological Survey</a> produces State-mandated regulatory maps that show "<a href="http://resilience.abag.ca.gov/earthquakes/">Zones of Required Investigation</a>" for liquefaction (and landslide) hazard. These state maps depict zones where site specific studies are required for new construction. These zone maps also are used in real estate transactions&mdash;sellers of properties within a "Zone of Required Investigation" must disclose that fact to prospective buyers.</figcaption>
    </figure>
  </div>
</div>
</li>
...
<h2>What Can I Do?</h2>
<p>To find out what you and your family should do to prepare, and to learn more about earthquake hazards in your community and neighborhood, please see these additional <a href="/contactus/menlo/prepare/">Earthquake Hazard Resources</a>.</p>
