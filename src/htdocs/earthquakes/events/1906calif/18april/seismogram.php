...
if (!isset($TEMPLATE)) {
  $TITLE = 'A Seismogram of the 1906 Earthquake';
  $HEAD = '';
  $NAVIGATION  = true;
...
<p> Compare the above 1906 seismogram to one recorded on the
same instrument at the same location after the <a href="got_seismogram_lp.php">1989 Loma Prieta earthquake</a>.</p>
