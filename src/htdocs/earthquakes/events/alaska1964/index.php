<?php
      ...
      //  Contact:
      if  (!isset($TEMPLATE))  {
      $TITLE  =  'The Great M9.2 Alaska Earthquake and Tsunami of March 27, 1964';
      $HEAD = '
...
<ul class="no-style linklist">
  ...
  <li>
    <a href="http://www.aeic.alaska.edu/quakes/Alaska_1964_earthquake.html">
      <h4>The Great Alaska Earthquake of 1964</h4>
...
<ul class="no-style linklist">
  ...
  <li>
    ...
    <p>&ldquo;The 1964 Great Alaska Earthquake and Tsunami&rdquo; lecture by George Plafker, USGS Geologist Emeritus.</p>
  </li>

  <li>
    <a href="https://www.youtube.com/watch?v=L6TBcOpDLv0">
      <h4>The 1964 Great Alaska Earthquake&mdash;What Happened and Why</h4>
...
<ul class="no-style linklist">
  ...
  <li>
    <a href="https://www.youtube.com/playlist?list=PL6CTSbjiglPq2gBswCl2Fa-Mios6Xy91c">
      <h4>Clips of the Great Alaska Earthquake from The Alaska Film Archives</h4>
...
<ul class="no-style linklist">
  ...
  <li>
    <a href="http://srl.geoscienceworld.org/content/85/2/245.full">
      <h4>Why the 1964 Great Alaska Earthquake Matters 50 Years Later</h4>
